...
module.exports = {
    run: async function (domain, step) {
        ...
        try {
            ...
            await logger.log(page, 'Sales', `${step}01`, 'At the login screen');
            ...
            await page.waitForSelector(selector);
            await logger.log(page, 'Sales', `${step}02`, 'At the dashboard screen');
            ...
            await page.waitForSelector(selector);
            await logger.log(page, 'Sales', `${step}03`, 'At the contact list screen');
            ...
            await page.waitForSelector(selector);
            await logger.log(page, 'Sales', `${step}04`, 'At the company list screen');
            ...
            await page.waitForSelector(selector);
            await logger.log(page, 'Sales', `${step}05`, 'At the opportunity list screen');
            ...
            await page.waitForSelector(selector);
            await logger.log(page, 'Sales', `${step}06`, 'At the history screen');
            ...
            await page.waitForSelector(selector);
            await logger.log(page, 'Sales', `${step}07`, 'At the quarter quotas screen');
            ...
            await page.waitForSelector(selector);
            await logger.log(page, 'Sales', `${step}08`, 'At the closed opportunities screen');
            ...
            await page.waitForSelector(selector);
            await logger.log(page, 'Sales', `${step}09`, 'At the dashboard screen');
            ...
            selector = 'a#OutSystemsUIWeb_wt13_block_wtLogin_wt8_wtListRecordsSalesManagers_ctl00_wt29';
            await page.waitForSelector(selector);
            await logger.log(page, 'Sales', `${step}10`, 'Logged out');
        } catch (error) {
