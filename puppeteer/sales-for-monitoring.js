...
module.exports = {
    run: async function (domain, step) {
        ...
        try {
            ...
            await logger.trace(page, 'Sales Monitoring Exercises', `${step}01`, 'At the login screen');
            ...
            await page.waitForSelector(selector);
            await logger.trace(page, 'Sales Monitoring Exercises', `${step}02`, 'At the dashboard screen');
            ...
            await page.waitForSelector(selector);
            await logger.trace(page, 'Sales Monitoring Exercises', `${step}03`, 'At the contact list screen');
            ...
            await page.waitForSelector(selector);
            await logger.trace(page, 'Sales Monitoring Exercises', `${step}04`, 'At the company list screen');
            ...
            await page.waitForSelector(selector);
            await logger.trace(page, 'Sales Monitoring Exercises', `${step}05`, 'At the opportunity list screen');
            ...
            await page.waitForSelector(selector);
            await logger.trace(page, 'Sales Monitoring Exercises', `${step}06`, 'At the history screen');
            ...
            await page.waitForSelector(selector);
            await logger.trace(page, 'Sales Monitoring Exercises', `${step}07`, 'At the quarter quotas screen');
            ...
            await page.waitForSelector(selector);
            await logger.trace(page, 'Sales Monitoring Exercises', `${step}08`, 'At the closed opportunities screen');
            ...
            await page.waitForSelector(selector);
            await logger.trace(page, 'Sales Monitoring Exercises', `${step}09`, 'At the dashboard screen');
            ...
            for (let loginStep = 0; loginStep < 10; loginStep++) {
                ...
                await page.waitForSelector(selector);
                await logger.trace(page, 'Sales Monitoring Exercises', `${step}${loginStep}11`, 'Failed login attempt');
            }
        } catch (error) {
