...
module.exports = {
    run: async function (domain, step) {
        ...
        try {
            ...
            await logger.log(page, 'Directory', `${step}01`, 'At the login screen');
            ...
            await page.waitForSelector(selector);
            await logger.log(page, 'Directory', `${step}02`, 'At the employee list screen');
            ...
            await page.waitForSelector(selector);
            await logger.log(page, 'Directory', `${step}03`, 'At the edit employee screen');
            ...
            await page.waitForSelector(selector);
            await logger.log(page, 'Directory', `${step}04`, 'At the org chart screen');
            ...
            await page.waitForSelector(selector);
            await logger.log(page, 'Directory', `${step}05`, 'At the organizations screen');
            ...
            await page.waitForSelector(selector);
            await logger.log(page, 'Directory', `${step}06`, 'At the office locations screen');
            ...
            await page.waitForSelector(selector);
            await logger.log(page, 'Directory', `${step}07`, 'At the job titles screen');
            ...
            await page.waitForSelector(selector);
            await logger.log(page, 'Directory', `${step}08`, 'At the floor plan edit screen');
            ...
            selector = 'div#wt97_wtMainContent_wtFilters_Wrapper';
            await page.waitForSelector(selector);
            await logger.log(page, 'Directory', `${step}09`, 'At the employee list screen');
            ...
            await page.waitForSelector(selector);
            await logger.log(page, 'Directory', `${step}10`, 'Logged out');
        } catch (error) {
